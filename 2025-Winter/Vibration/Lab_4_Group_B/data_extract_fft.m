...
figure(1)
plot(tb_n,ygb,'DisplayName','Base')
hold on
plot(tb_n,yg1_i,'DisplayName','Mass 1')
plot(tb_n,yg2_i,'DisplayName','Mass 2')
hold off
grid on
xlabel('Time (s)')
ylabel('y acceleration (g)')
title('Base excitation vibration 2DOF system')
hold off
legend
...
% plotspec(2048,delt,ygb(end-2047:end),yg2_i(end-2047:end));
plotspec(2048,delt,ygb,yg1_i);
plotspec(2048,delt,ygb,yg2_i);
