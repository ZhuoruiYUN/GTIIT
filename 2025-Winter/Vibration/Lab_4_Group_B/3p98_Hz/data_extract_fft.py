...
tb_n  = data1['tb_n'].values
ygb = data1['ygb'].values
yg1_i = data1['yg1_i'].values
...
figure(1)
plot(tb_n,ygb,label = 'Base')
plot(tb_n,yg1_i,label = 'Mass 1')
plot(tb_n,yg2_i,label = 'Mass 2')
xlabel('time (s)')
ylabel('y acceleration (g)')
grid(True)
legend(loc='lower right')
title('Base excitation of 2DOF system')
show()
